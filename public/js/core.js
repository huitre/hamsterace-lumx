...
angular.module('Hamsterace.Services').factory('AuthenticationService',
  ...
  function ($cookieStore, $http, $rootScope, Base64) {
    var sdo = {
      isLoggedIn: false,
      username: ''
    };
    ...
    var _urls = {
      auth: Config.api.url + 'login',
      signup: Config.api.url + 'signup'
    };

    return {
      login: function(data, callback) {        
        return $http.post(_urls.auth, data).then(function (res) {
          res.success = true;
          callback(res);
        }, function (e) {
...
* @Last Modified by:   huitre
* @Last Modified time: 2015-05-10 11:40:12
*/

'use strict';
  
angular.module('Hamsterace').controller(['HomeController',
    function ($scope) {
